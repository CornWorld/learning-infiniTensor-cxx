...
int main(int argc, char **argv) {
    {
        ...
        ASSERT(sizeof(vec) == 24 /* 这玩意不是依赖于平台吗?? */, "Fill in the correct value.");
        int ans[]{1, 2, 3, 4, 5};
    ...
    }
    {
        ...
        ASSERT(sizeof(vec) == 24, "Fill in the correct value.");
        {
            ...
            ASSERT(vec.capacity() == capacity, "Fill in a correct identifier."); // 不改变
        }
        {
            vec.reserve(256);
            ASSERT(vec.size() == 16, "Fill in the correct value.");
        ...
        }
        {
            ...
            ASSERT(vec[16-1+1] == 'a', "Fill in the correct value.");
            ASSERT(vec[16-1+2] == 'b', "Fill in the correct value.");
            ASSERT(vec[16-1+3] == 'c', "Fill in the correct value.");
            ASSERT(vec[16-1+4] == 'd', "Fill in the correct value.");
        }
    }
